      ...
      <Measure className="mx-auto">
        ...
        <Section title="The service">
          <p className="text-muted leading-relaxed">
            {site.name} indexes App Store apps whose revenue is read directly from a payment
            provider the founder connects. It is an index, not a broker, an auditor, or a financial
            adviser.
          </p>
        </Section>
        ...
        <Section title="Listing an app">
          <p className="text-muted leading-relaxed">
            ...
            publish the resulting figures — monthly recurring revenue, growth, subscriber counts —
            on your app&apos;s public page. You keep ownership of everything you write. You grant us
            permission to display it here.
          </p>
          <p className="text-muted mt-4 leading-relaxed">
            You may disconnect at any time. Doing so stops further reads and removes the app from
            the index; history already published may persist in caches and third-party archives
            beyond our control.
          </p>
        </Section>
        ...
        <Section title="Accuracy, and its limits">
          <p className="text-muted leading-relaxed">
            Figures are reported by the connected provider and normalised to a monthly equivalent.
            We do not audit them, and a provider can itself be wrong, delayed, or temporarily
        ...
        <Section title="Availability">
          <p className="text-muted leading-relaxed">
            The service is provided as-is, with no guarantee of uptime, and may change or end. To
            the extent the law allows, we are not liable for losses arising from use of the site,
            reliance on a figure shown here, or an interruption to it.
          </p>
        </Section>

        <Section title="Not affiliated with Apple">
          <p className="text-muted leading-relaxed">
            {site.name} is independent of Apple Inc. App Store metadata comes from Apple&apos;s
            public iTunes lookup API. Apple, App Store, and related marks belong to Apple Inc.
          </p>
        </Section>
        ...
        <Section title="Changes and contact">
          <p className="text-muted leading-relaxed">
            ...
            after a change accepts it. They are governed by the laws of {site.jurisdiction}.
            Questions go to{' '}
