    ...
    <div className="mx-auto max-w-2xl px-4 py-10 sm:px-6 sm:py-16">
      ...
      <Section title="What we store">
        ...
        <Item term="Profile">
          ...
          is published on your founder page, and all of it is optional except the handle.
        </Item>
      ...
      <Section title="What we don't store">
        <p className="text-muted leading-relaxed">
          ...
          cross-site tracking to opt out of. Page popularity is counted as a single daily total per
          app — a number incremented per view, with no visitor identifier, IP address, or device
          record attached. We cannot tell which pages any individual visited, and neither can anyone
      ...
      <Section title="Provider credentials">
        <p className="text-muted leading-relaxed">
          ...
          in the server environment and never in the database. A stolen database dump does not yield
          working credentials. Keys are decrypted only in memory, only to make the scheduled read,
          and are never returned to a browser — not even yours. Disconnecting a provider deletes the
      ...
      <Section title="Your choices">
        <p className="text-muted leading-relaxed">
          You can edit or clear your profile and insights at any time from the dashboard, disconnect
          a provider to stop revenue being read, or ask us to delete your account entirely. Deleting
          an account removes your profile, your apps, and their revenue history. Reach us at{' '}
